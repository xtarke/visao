...
% Outras possibilidades do algoritmo são:
% Mudar o método de encontrar os circulos: 'Method','twostage' 
% Mudar a polaridade para bright para encontrar os objetos mais claros que
% o fundo
% Mudar EdgeThreshold que é responsável pelo "o que" vai ser considerado
% uma borda para detecção das circunferencias