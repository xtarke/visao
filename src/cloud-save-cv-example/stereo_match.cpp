...
{
    std::string img1_filename = "./Frame_l_00000.png";
    std::string img2_filename = "./Frame_r_00000.png";
    std::string intrinsic_filename = "./intrinsics.yml";
    std::string extrinsic_filename = "./extrinsics.yml";
    std::string disparity_filename = "disp.png";
    std::string point_cloud_filename = "cloud.txt";
